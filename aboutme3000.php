...
function widget_aboutme($args) {
    ...
    for ($i=0;$i<count($arr_am_titles);$i++) {
        ...
        if($i == 6)  echo "<a style='padding:2px' href='http://".$options[$tag_id].".stumbleupon.com/'><img src='".get_bloginfo('wpurl')."/wp-content/plugins/about-me-3000/".$tag_id.".png' border='0'></a>";
        else   
